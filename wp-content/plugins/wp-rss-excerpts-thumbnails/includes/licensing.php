 ...
 */
function wprss_et_init_updater() {
	if ( method_exists(wprss_licensing_get_manager(), 'initUpdaterInstance') ) {
		wprss_licensing_get_manager()->initUpdaterInstance('et', WPRSS_ET_SL_ITEM_NAME, WPRSS_ET_VERSION, WPRSS_ET_PATH, WPRSS_ET_SL_STORE_URL);
	}
}
